    ...
    moreContentButton.addEventListener("click", () => {
        ...
        moreContentButton.innerText = moreContentButton.innerText === "Voir plus" ? "Voir moins" : "Voir plus";
    });
});
document.addEventListener("DOMContentLoaded", () => {
    ...
    moreCorpsButton.addEventListener("mousedown", () => {
        ...
        moreCorpsButton.innerText = moreCorpsButton.innerText === "Voir plus" ? "Voir moins" : "Voir plus";
    })
});